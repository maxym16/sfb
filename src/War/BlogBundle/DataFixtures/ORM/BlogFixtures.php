...
namespace War\BlogBundle\DataFixtures\ORM;

use Doctrine\Common\DataFixtures\AbstractFixture;
use Doctrine\Common\DataFixtures\OrderedFixtureInterface;
use Doctrine\Common\Persistence\ObjectManager;
use War\BlogBundle\Entity\Blog;
...
$blog1->setTags('symfony2, php, paradise, warblog');
...
$blog2->setBlog('Vestibulum vulputate mauris eget erat congue dapibus imperdiet justo scelerisque. Na. Cras elementum molestie vestibulum. Morbi id quam nisl. ');
$blog2->setImage('pool_leak.jpg');
$blog2->setAuthor('Zero Cool');
$blog2->setTags('pool, leaky, hacked, movie, hacking, warblog');
...
$blog3->setTags('misdirection, magic, movie, hacking, warblog');
...
$blog4->setTags('grid, daftpunk, movie, warblog');
...
$blog5->setTags('binary, one, zero, alive, dead !trusting, movie, warblog');
