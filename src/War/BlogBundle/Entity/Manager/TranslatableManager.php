...
namespace War\BlogBundle\Entity\Manager;
...
class TranslatableManager
{
    ...
    {
        if (null !== $container) {
            if (!$this->repository instanceof BlogRepository) {
                throw new \InvalidArgumentException('A TranslatableManager needs to be linked with a BlogRepository to sets default locale.');
            }
